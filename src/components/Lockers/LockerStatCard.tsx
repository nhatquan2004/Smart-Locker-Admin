...
import type {TLockerStatItem} from '../../types/locker.type'
import styles from './LockerStatCard.module.css'

type TProps = {
    item: TLockerStatItem
}

const iconMap: Record<TLockerStatItem['id'], string> = {
    total: '📦',
    available: '✅',
    occupied: '🔒',
    issue: '⚠️',
...
export function LockerStatCard({item}: TProps) {
